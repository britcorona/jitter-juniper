...
using System.Linq; //branch nov_23
...
namespace Jitter.Tests.Models
{
    ...
    public class JitterRepositoryTests
    {
        ...
        {
            var data_source = data_store.AsQueryable<JitterUser>(); //Red squiggly, and added using linq.
            // HINT: var data_source = (data_store as IEnumerable<JitterUser>).AsQueryable();
